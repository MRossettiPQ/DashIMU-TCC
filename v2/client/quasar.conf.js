...
// const { createHelpers } = require('app/scripts/create-helpers');
...
module.exports = configure(async function (/* ctx */) {
  ...
  return {
    ...
    boot: ['i18n', 'axios', 'components', 'validators'],
    ...
    pwa: {
      ...
      manifest: {
        name: 'Dash IMU Typescript',
        short_name: 'Dash IMU Typescript',
        description: 'Dash IMU Typescript',
        display: 'standalone',
