...
exports.getAllCalc = async (movements, newSession) => {
  console.log('[Service] - /api/session/:id/scilab - getaAllCalc')
  let result = []
  for (let movement of movements) {
    const calc = await this.calculationVariabilityCenter(movement.sensors, newSession, 'eChart')
    result.push({
      movement,
      ...calc,
    })
...
exports.calculationVariabilityCenter = (sensors, session, chartType = 'eChart') => {
...
exports.getEChartOptions = ({ session, max_atorn }) => {
