...
export default {
  ...
  session: {
    ...
    procedure_next_error: "Existem erros no formulário, revise-o e tente novamente.",
    sensor_next_error: "Numero de sensores inferior ao mínimo requerido para o procedimento.",
