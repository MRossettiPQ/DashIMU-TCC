<template>
  <q-page class="home">
    ...
    <div v-else-if="fetchData.result !== null" class="column justify-center content-center" style="gap: 12px">
      ...
      <div class="ip">
        ...
        <span v-if="fetchData?.result?.metadata" class="col text-black text-center" style="font-size: 36px; font-weight: bolder">
