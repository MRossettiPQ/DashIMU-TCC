...
export function throwError({ message = ServerResponses.InternalError.message, local = "", log = "", responseType = "content" }) {
  // Error 500
...
export function throwSuccess({ content = null, message = "", log = "", local = "", responseType = "content" }: RequestReturn) {
  // Success 200
...
export function throwForbidden({ message = null, local = "SERVER:FORBIDDEN", log = "", responseType = "content" }: RequestReturn) {
  // Error 403
  return new Promise((resolve, reject) => {
    return reject({
      type: "Forbidden",
...
export function throwNotFound({ message = null, local = "SERVER:NOTFOUND", log = "", responseType = "content" }: RequestReturn) {
  // Error 404
  return new Promise((resolve, reject) => {
    return reject({
      type: "NotFound",
...
export function throwUnauthorized({ message = null, local = "SERVER:UNAUTHORIZED", log = "", responseType = "content" }: RequestReturn) {
  // Error 401
  return new Promise((resolve, reject) => {
    return reject({
      type: "Unauthorized",
