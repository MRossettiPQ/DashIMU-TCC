...
import { CustomModelStatic, OrderItem } from "../database";
...
export async function PaginationUtil(entity: CustomModelStatic, { rpp = 10, page = 0, field = "", order = [], where = null, options }: PaginationOptions = {}): Promise<any> {
