...
export interface SensorModel extends Model<InferAttributes<SensorModel>, InferCreationAttributes<SensorModel>> {
...
export default function Sensor(sequelize: Sequelize): CustomModelStatic {
  ...
  Sensor.associate = ({ Movement, GyroMeasurement }: LoadedCustomModels): CustomModelStatic => {
