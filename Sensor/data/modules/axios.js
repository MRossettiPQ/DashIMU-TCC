!(function (e, t) {
  ...
  function R(t, n) {
    var r,
      ...
      a = void 0 !== s && s;
    if (null != t)
      if (("object" !== e(t) && (t = [t]), l(t))) for (r = 0, o = t.length; r < o; r++) n.call(null, t[r], r, t);
      else {
        var u,
  ...
  function _(e, t, n, r, o) {
    Error.call(this),
      ...
      (this.message = e),
      (this.articulation_name = "AxiosError"),
      t && (this.code = t),
      n && (this.config = n),
      r && (this.request = r),
      o && (this.response = o);
  ...
  function q(t, n, r) {
    ...
    n = n || new (F || FormData)();
    var o,
      i = (r = P.toFlatObject(r, { metaTokens: !0, dots: !1, indexes: !1 }, !1, function (e, t) {
    ...
    var d = [],
      h = Object.assign(z, { defaultVisitor: l, convertValue: f, isVisitable: U });
  ...
  function re(e, t, n) {
    _.call(this, null == e ? "canceled" : e, _.ERR_CANCELED, t, n), (this.articulation_name = "CanceledError");
  }
        ...
        if (u) {
          ...
          !(function (e, t, n) {
            ...
            n.status && r && !r(n.status)
              ? t(new _("Request failed with status code " + n.status, [_.ERR_BAD_REQUEST, _.ERR_BAD_RESPONSE][Math.floor(n.status / 100) - 4], n.config, n.request, n))
              : e(n);
          })(
            function (e) {
              t(e), a();
        ...
        r(e, [
          {
            ...
            value: function (e, t) {
              ...
              i &&
                P.forEach(["delete", "get", "head", "post", "put", "patch", "common"], function (e) {
                  delete t.headers[e];
                }),
  ...
  P.forEach(["delete", "get", "head", "options"], function (e) {
    Ce.prototype[e] = function (t, n) {
      return this.request(Se(n || {}, { method: e, url: t, data: (n || {}).data }));
    };
  }),
    P.forEach(["post", "put", "patch"], function (e) {
      function t(t) {
